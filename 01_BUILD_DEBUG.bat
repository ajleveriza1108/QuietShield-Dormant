...
copy /y "app\build\outputs\apk\debug\app-debug.apk" "release\debug\QuietShield-Dormant-v0.1.0-alpha3-r6-debug.apk" >nul

echo.
echo [PASS] release\debug\QuietShield-Dormant-v0.1.0-alpha3-r6-debug.apk
pause
exit /b 0
