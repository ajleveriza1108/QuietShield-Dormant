...
set "APK=release\beta\QuietShield-Dormant-v0.2.0-beta1-r4.apk"
if not exist "%APK%" (
...
echo ============================================================
echo QuietShield Dormant v0.2.0 Beta 1 R4 Phone Installation
echo ============================================================
"%ADB%" devices
"%ADB%" install -r "%APK%"
if errorlevel 1 (
...
echo [PASS] QuietShield Dormant Beta 1 R4 installed.
