...
QuietShield Dormant Beta 1 R3 is experimental software with privileged control available only after the user deliberately completes Wireless Debugging setup.
