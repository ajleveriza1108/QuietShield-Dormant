...
if not exist "release\debug\QuietShield-Dormant-v0.1.0-alpha4-wireless-debug.apk" (
...
"%ADB%" devices
"%ADB%" install -r "release\debug\QuietShield-Dormant-v0.1.0-alpha4-wireless-debug.apk"
if errorlevel 1 (
