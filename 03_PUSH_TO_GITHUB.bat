...
if errorlevel 1 git commit -m "QuietShield Dormant v0.2.0 Beta 1 R4: helper launch reliability after wireless pairing" || goto failed
git push -u origin main || goto failed

echo [PASS] QuietShield Dormant Beta 1 R4 pushed to GitHub.
pause
exit /b 0
